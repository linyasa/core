...
public class HistoricalPushedAsset implements Serializable {
    ...
    public HistoricalPushedAsset() {}

    public HistoricalPushedAsset(String bundleId, String assetId, String assetType, Date pushDate, String environmentId) {
